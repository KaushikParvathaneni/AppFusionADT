...
def update_app():
    ...
    updated_dev_name = st.text_input("Updated Developer Name", existing_app_data.iloc[0]['Developer'])  # Added line for developer update
    updated_price = st.text_input("Updated Price", existing_app_data.iloc[0]['Price'])  # Added line for pricing update
